...
const ProductDetail = () => {
  ...
  return (
    <div className="flex mt-3 justify-center px-1">
      ...
      {Object.keys(productDetail).length > 0 && !errorMessage && (
        <div className="grid grid-col-1 md:grid-cols-2 md:w-11/12 max-w-[1000px]">
          <ProductImage
            imagePath={imagePath}
          ...
          <div>
            <div
              className={`mt-3 w-[310px] px-2 mx-auto ${styles.Description}`}
            >
